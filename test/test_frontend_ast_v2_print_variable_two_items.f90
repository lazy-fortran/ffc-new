program test_frontend_ast_v2_print_variable_two_items
    ...
    write (*, '(a)') 'frontend AST v2 variable two-item PRINT checks: ok'
...
contains
    ...
    function positive_sx() result(value)
        ...
        value = '(program-unit-v2 (root (program-root (name main) (span (source-span '// &
            '(file main.f90) (start-byte 0) (end-byte 79) (source-hash print-variable-two-item))))) '// &
            '(declaration-count 1) (declaration (program-declaration (declaration-kind program) '// &
            '(name main) (span (source-span (file main.f90) (start-byte 0) (end-byte 79) '// &
            '(source-hash print-variable-two-item))))) (variable-count 1) '// &
            '(variable (variable-declaration (type-spec integer) (name x) (span (source-span '// &
            '(file main.f90) (start-byte 10) (end-byte 20) (source-hash print-variable-two-item))))) '// &
...
end program test_frontend_ast_v2_print_variable_two_items
