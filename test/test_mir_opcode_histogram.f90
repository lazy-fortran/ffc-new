program test_mir_opcode_histogram
    ...
    use ffc_mir, only: mir_function_body_t, mir_function_opcode_histogram_at, &
        ...
        opcode_call, opcode_compare, opcode_div, opcode_load, opcode_mul, opcode_output, opcode_pow, &
    ...
    expected = [3_int32, 0_int32, 0_int32, 0_int32, 0_int32, 0_int32, 0_int32, &
        0_int32, 0_int32, 2_int32, 0_int32, 0_int32, 0_int32]
    ...
    call make_body(body, [opcode_add, opcode_sub, opcode_mul, opcode_div, opcode_load, &
        opcode_store, opcode_compare, opcode_branch, opcode_call, opcode_return, opcode_output, opcode_pow])
    expected = [1_int32, 1_int32, 1_int32, 1_int32, 1_int32, 1_int32, 1_int32, &
        1_int32, 1_int32, 1_int32, 0_int32, 1_int32, 1_int32]
    call assert_histogram(body, expected, 12_int32, 'all opcodes')
