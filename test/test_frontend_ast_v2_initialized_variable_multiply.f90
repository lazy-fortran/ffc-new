program test_frontend_ast_v2_initialized_variable_multiply
    ...
    call assert_true(ffc_lower_frontend_ast_v2_from_sx(positive_sx(), body, message), &
        'initialized variable-multiply source was rejected')
    ...
    call assert_false(ffc_lower_frontend_ast_v2_from_sx(replace_text(positive_sx(), &
        ...
        'mutated assignment name was accepted')
    call assert_false(ffc_lower_frontend_ast_v2_from_sx(replace_text(positive_sx(), &
        '(source-hash initialized-variable-multiply)', '(source-hash mutated)'), body, message), &
        'mutated source identity was accepted')

    write (*, '(a)') 'frontend AST v2 initialized variable-multiply MIR checks: ok'
...
contains
    ...
    function positive_sx() result(value)
        ...
        value = '(program-unit-v2 (root (program-root (name main) (span (source-span '// &
            ...
            '(source-hash initialized-variable-multiply))))) (declaration-count 1) '// &
            ...
            '(source-hash initialized-variable-multiply))))) (variable-count 1) '// &
            '(variable (variable-declaration (type-spec integer) (name x) '// &
            '(span (source-span (file main.f90) (start-byte 10) (end-byte 20) '// &
            '(source-hash initialized-variable-multiply))))) (execution-part '// &
            ...
            '(source-hash initialized-variable-multiply))))) (assignment (assignment-stmt '// &
            ...
            '(source-hash initialized-variable-multiply)))))) (print-stmt '// &
            ...
            '(output-page 248) (source-hash initialized-variable-multiply))))'
...
end program test_frontend_ast_v2_initialized_variable_multiply
