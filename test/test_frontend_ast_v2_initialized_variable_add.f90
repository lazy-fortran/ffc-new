program test_frontend_ast_v2_initialized_variable_add
    ...
    if (.not. ffc_lower_frontend_ast_v2_from_sx(positive_sx(), body, message)) then
        ...
        error stop 'initialized variable-add source was rejected'
    end if
    ...
    do instruction_index = 1, 9
        ...
        call assert_true(body%instructions(instruction_index)%result%id == &
            expected_results(instruction_index), &
            'result ID sequence changed')
...
contains
    ...
    function positive_sx() result(value)
        ...
        value = '(program-unit-v2 (root (program-root (name main) (span (source-span '// &
            ...
            '(source-hash initialized-variable-add))))) (declaration-count 1) '// &
            ...
            '(source-hash initialized-variable-add))))) (assignment (assignment-stmt '// &
            ...
            '(source-hash initialized-variable-add)))))) (print-stmt '// &
            ...
            '(output-page 248) (source-hash initialized-variable-add))))'
...
end program test_frontend_ast_v2_initialized_variable_add
