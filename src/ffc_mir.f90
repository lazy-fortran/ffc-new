module ffc_mir
    ...
    use ffc_mir_metadata, only: mir_opcode_histogram_size, mir_opcode_name, &
        ...
        opcode_const, opcode_mul, opcode_output, opcode_pow, opcode_return, opcode_store, opcode_sub, &
        value_kind_address, &
...
contains
    ...
    logical function mir_validate_instruction(instruction, message) result(valid)
        ...
        if (instruction%opcode < opcode_add .or. instruction%opcode > opcode_pow) then
